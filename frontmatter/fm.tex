\newcommand\thesistitle{Search for Dark Matter Candidates Produced in $Z(\ell\ell)+E_{T}^\text{miss}$ Events in 13 TeV Proton-Proton Collisions with the ATLAS Detector at the Large Hadron Collider}
