...
Using the CL$_s$ method, any $\mu$ values that give CL$_s<0.05$ are excluded at the 95\% CL. The upper limits are then extracted from HistFitter, and dark matter mass exclusion limits are produced using the MonoZLimitsUVic framework that was written for this purpose.
...
\begin{figure}[htb]
    ...
    \end{subfigure}
    \caption{limits of amazing tings}\label{fig:limits}
\end{figure}
